...
4. Record the exact original text you will change, then make a harmless source edit to the open story module so Studio reloads it.
...
7. Restore the exact original text you recorded. Confirm the temporary edit no longer appears in the diff without discarding any other changes.
