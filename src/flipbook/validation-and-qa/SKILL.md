...
**Measurement guidance:** Use `diagnostics-and-tooling` skill for logging, filtering, and sourcemap inspection rather than eyeballing.
...
Use `debugging-playbook` for detailed triage.
