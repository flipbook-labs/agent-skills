...
**Verified (2026-07-01):** Path-length check artifacts no longer exist on main; no `.github/actions/check-path-lengths/` directory. Rbxm bundling remains permanently active in `.lute/lib/build-system/compileAsync.luau` (grep `packToRbxm`):
