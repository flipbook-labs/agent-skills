...
Triggered by pushes to main, release events, manual dispatch, and pull requests labeled `debug:release-pr`:
...
| ---------------------------- | ----- | -------------------- | ---------------------------------------------------- |
| FLIPBOOK_BACKEND_CLIENT_ID   | org   | Public GitHub App ID | Used with the private key to generate release tokens |
...
**Last verified:** 2026-09-13 (Changewrite v0.7.0 on current `main`)
