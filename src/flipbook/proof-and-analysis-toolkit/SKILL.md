...
Cross-reference instead: `build-and-toolchain` for Darklua pipeline depth; `diagnostics-and-tooling` for measurement infrastructure; `failure-archaeology` for symptom→root-cause playbook.
