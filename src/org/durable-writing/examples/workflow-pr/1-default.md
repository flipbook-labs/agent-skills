<!-- doctrine-exempt rules="em-dash" reason="The default draft this example criticizes, reproduced verbatim down to the dashes an agent reaches for while narrating a diff." -->
